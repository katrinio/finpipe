...
def test_invoice_amount_button_starts_waiting_state_and_prompts(tmp_path: Path) -> None:
    ...
    assert telegram_client.sent_messages == ["💰 Введите сумму Invoice:"]
    assert telegram_client.sent_message_payloads == [(123, "💰 Введите сумму Invoice:", None)]
...
def test_invoice_amount_state_saves_valid_number_and_clears_state(tmp_path: Path) -> None:
    ...
    assert telegram_client.sent_messages == [
        "💰 Введите сумму Invoice:",
        "✅ Сумма Invoice сохранена: 1500 EUR",
    ]
    assert telegram_client.sent_message_payloads == [
        (123, "💰 Введите сумму Invoice:", None),
        (123, "✅ Сумма Invoice сохранена: 1500 EUR", None),
    ]
